...
export const About = () => {
  return (
    <>
      <div
        className={' about-section text-white'}
        style={{ backgroundColor: '#C1C3C0' }}
      >
        <div className='row'>
          <div className='container col-sm-12 col-md-12 col-lg-6'>
            <h1 className='text-heading text-dark text-center mt-4'>
              About Us
            </h1>
          </div>
          <div className='container col-sm-12 col-md-12 col-lg-6'>
        ...
        <div className='text-dark col-sm-12 col-md-12 col-lg-12'>
          <p>
            ...
            warmth of freshly baked goods. <br />
            <br />
            ...
            innovative twists.
            <br />
            <br /> From the moment you step into our bakery, you're enveloped in
            ...
            <br />
            <br /> As we knead, roll, and bake, we're not just making pastries –
            we're crafting memories. From birthday celebrations marked by our
            custom cakes to lazy Sunday mornings made better with our artisanal
            bread, we're there for life's sweetest moments. Our journey is one
            of passion, flavor, and the joy that comes from spreading happiness,
